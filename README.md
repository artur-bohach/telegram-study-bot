...
- синхронізує розклад у межах предметів і дат, присутніх у поточному Excel-файлі;
- видаляє застарілі `Lesson`, яких більше немає у файлі, але лише в межах цього
  імпортованого scope.
